...
class Jem_Cpow_Password {
	...
	?>
        ...
        <td class="value leftside">
            <input <?php echo $data['required']; ?> type="password" name="jempa_fields[<?php echo $data['unique_name']; ?>]" value="<?php echo @$data['value']; ?>" class="jem-input-field <?php echo $data['class']; ?>" placeholder="<?php echo $data['placeholder']; ?>" id="<?php echo $data['unique_name']; ?>">
        </td>
    	</tr>
    	<?php
