...
class Jem_Cpow_Email {
	...
	?>
        ...
        <td class="value leftside">
            <input type="email" name="jempa_fields[<?php echo $data['unique_name']; ?>]" value="<?php echo @$data['value']; ?>" class="jem-input-field <?php echo $data['class']; ?>" placeholder="<?php echo @$data['placeholder']; ?>" <?php echo $data['required']; ?> id="<?php echo $data['unique_name']; ?>">
        </td>
    	</tr>
    	<?php 
		...
		// Apply Filters HTML
		return apply_filters('jem_cpow_admin_email_field_html', $html);
	}
