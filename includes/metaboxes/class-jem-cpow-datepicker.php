...
class Jem_Cpow_DatePicker {
	...
	/**
	 * Add Date Picker Fields HTML
	 *
	 * @return Date Picker html
	 * @package Custom Product Options for WooCommerce
		 * @since 1.0.0
	 */
	...
	?>
        ...
        <td class="value leftside">
            <input type="text" name="jempa_fields[<?php echo $data['unique_name']; ?>]" value="<?php echo @$data['value']; ?>" class="jem-date jem-input-field <?php echo $data['class']; ?>" placeholder="<?php echo $data['placeholder']; ?>" <?php echo $data['required']; ?> id="<?php echo $data['unique_name']; ?>">
        </td>
    	</tr>
    	<?php 
